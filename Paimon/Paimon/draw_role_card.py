...
region = load_json(path=Path(__file__).parent/ 'utils' / 'json_data' / 'role_region.json')
...
async def draw_role_card(uid, data):
    ...
    bg_draw.text((24, bg.size[1] - 50), '   Created by ATRI | Powered by Enka.Network', fill='white',
